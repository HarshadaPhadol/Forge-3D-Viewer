...
namespace AutoDesk.Controllers
{
  public class DataManagementController : ControllerBase
  {
    ...
    private async Task<IList<jsTreeNode>> GetHubsAsync()
    {
      ...
      hubsApi.Configuration.AccessToken = "5nsVj9Jj4JWLz2ma6a2adjEuDqqzdOpS";
    ...
    private async Task<IList<jsTreeNode>> GetProjectsAsync(string href)
    {
      ...
      projectsApi.Configuration.AccessToken = "5nsVj9Jj4JWLz2ma6a2adjEuDqqzdOpS";
    ...
    private async Task<IList<jsTreeNode>> GetProjectContents(string href)
    {
      ...
      projectApi.Configuration.AccessToken = "5nsVj9Jj4JWLz2ma6a2adjEuDqqzdOpS";
    ...
    private async Task<IList<jsTreeNode>> GetFolderContents(string href)
    {
      ...
      folderApi.Configuration.AccessToken = "5nsVj9Jj4JWLz2ma6a2adjEuDqqzdOpS";
    ...
    private async Task<IList<jsTreeNode>> GetItemVersions(string href)
    {
      ...
      itemApi.Configuration.AccessToken = "5nsVj9Jj4JWLz2ma6a2adjEuDqqzdOpS";
